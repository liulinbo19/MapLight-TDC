...
def get_fingerprints(smiles):
    ...
    # fingerprints.append(get_atom_pair_fingerprints(molecules, n_bits=2048))
    # fingerprints.append(get_layered_fingerprints(molecules, n_bits=2048))
    fingerprints.append(get_feat_morgan_fingerprints(molecules, n_bits=1024, radius=2))
